...
import ArrowBackIcon from "@mui/icons-material/ArrowBack"; //vima
import AddBaby from "@/components/AddBaby"; // vima
...
const InfantDetailsContent = () => {
  ...
  const [selectedInfantDetails, setSelectedInfantDetails] =
    useState<Infant | null>(null);
  const [subView, setSubView] = useState<
    "Profile" | "Vitals" | "History" | "LiveFeed"
  >("Profile");
  const [detailLoading, setDetailLoading] = useState(false);
  const [showAddBaby, setShowAddBaby] = useState(false); // vimansa
      ...
      {showAddBaby ? ( // vima
        <Box sx={{  mt: 0}}>
          ...
          >
            ...
            <Typography variant="body1" sx={{ ml: 0.5, color: 'blue' }}>
              Back
            </Typography>
          </Box>
          <AddBaby />
