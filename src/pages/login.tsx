          ...
          <div className="space-y-[53px] lg:space-y-[80px] 2xl:w-[540px]">
            ...
            <form onSubmit={handleSignin}>
              <div className="space-y-[12px] xl:space-y-[16px]">
                ...
                <h1 className="xl:mt-[2px] font-productsansregular text-end w-full cursor-pointer hover:opacity-75 hover:text-[#6673FC] text-10 lg:text-12"
                onClick={() => navigate("/Forgetpw")}>
                  Forget Password ?
                </h1>
                <button
                  className={`bg-[#6673FC] h-[32.17px] lg:h-[50px] font-productsans text-white w-full py-[8px] 2xl:py-[10px] text-12 md:text-16 ${
