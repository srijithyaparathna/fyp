              ...
              <form onSubmit={handleLogin}>
                <div className="space-y-[12px] xl:space-y-[16px]">
                  <div className="space-y-[18px] xl:space-y-[20px] flex flex-col">
                    ...
                    <div className="flex flex-col w-full space-y-[6px] md:space-y-[3px]">
                      <span className="text-12 md:text-[14px] "> Password</span>
                      <Input
                        type="password"
                  ...
                  <h1
                    className="xl:mt-[2px] text-end w-full cursor-pointer hover:opacity-75 hover:text-[#6673FC] text-[10px] lg:text-[12px]"
